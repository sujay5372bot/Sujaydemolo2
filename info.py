...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001975749985 knr_hdmovies1 -1002228043698 -1002148375787').split()]
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002262173450') # give your force subscribe channel id here else leave it blank
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1002262173450')
